...
test.describe('Projects - Update', () => {
    ...
    test('TC42: Cancel on edit page returns to project detail page', async ({ page }) => {
        await page.goto(`/projects/edit/${projectId}`)
        await waitForProjectPageLoad(page)

        await page.getByRole('button', { name: 'Cancel' }).click()
        await page.waitForURL('**/projects/detail/**', { timeout: 10000 })
        await expect(page).toHaveURL(new RegExp(`/projects/detail/${projectId}`))
    })
