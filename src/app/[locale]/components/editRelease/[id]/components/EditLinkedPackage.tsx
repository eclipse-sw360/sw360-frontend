...
export default function EditLinkedPackages({ releaseId, releasePayload, setReleasePayload }: Props): JSX.Element {
    ...
    const [dummyProjectPayload, setDummyProjectPayload] = useState<ProjectPayload>({
        id: '',
        name: '',
        packageIds: {},
    })
    ...
    useEffect(() => {
        const linkedPackages: ExtendedRelease['linkedPackages'] = []

        linkedPackageData.forEach((pkg) => {
            linkedPackages.push({
    ...
    return (
        <>
            <LinkPackagesModal
                ...
                projectPayload={dummyProjectPayload}
                setProjectPayload={setDummyProjectPayload}
            />
                ...
                <div className='row'>
                    <div className='col-12'>
                        {showProcessing ? (
                            ...
                            <>
                                <table className='table mb-0 linked-packages-table'>
                                    <thead
                                        style={{
