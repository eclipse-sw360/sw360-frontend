    ...
    return (
        <>
            {targetComponent && sourceComponent && finalComponentPayload && (
                <div className='mb-3'>
                    <h6 className='border-bottom fw-bold text-uppercase text-blue border-blue mb-2'>{t('Roles')}</h6>
                                ...
                                {sourceComponent.componentOwner === targetComponent.componentOwner ? (
                                    ...
                                    <button
                                        ...
                                        onClick={() =>
                                            setFinalComponentPayload({
                                                ...finalComponentPayload,
                                                componentOwner: sourceComponent.componentOwner,
                                            })
                                        }
                                    >
                                        <FaLongArrowAltLeft />
                                    ...
                                    <button
                                        ...
                                        onClick={() =>
                                            setFinalComponentPayload({
                                                ...finalComponentPayload,
                                                componentOwner: targetComponent.componentOwner,
                                            })
                                        }
                                    >
                                        <FaUndo />
                        ...
                        <div className='d-flex row'>
                            ...
                            <div className='col-12 col-md-2 mx-5 text-center'>
                                {sourceComponent.ownerAccountingUnit === targetComponent.ownerAccountingUnit ? (
                                  ...
                                  targetComponent.ownerAccountingUnit ? (
                                    <button
                                        className='btn btn-secondary px-2'
                                        onClick={() =>
                                            setFinalComponentPayload({
                                                ...finalComponentPayload,
                                                ownerAccountingUnit: sourceComponent.ownerAccountingUnit,
                                            })
                                        }
                                    >
                                        <FaLongArrowAltLeft />
                                    ...
                                    <button
                                        ...
                                        onClick={() =>
                                            setFinalComponentPayload({
                                                ...finalComponentPayload,
                                                ownerAccountingUnit: targetComponent.ownerAccountingUnit,
                                            })
                                        }
                                    >
                                        <FaUndo />
                                ...
                                {sourceComponent.ownerGroup === targetComponent.ownerGroup ? (
                                    ...
                                    <button
                                        ...
                                        onClick={() =>
                                            setFinalComponentPayload({
                                                ...finalComponentPayload,
                                                ownerGroup: sourceComponent.ownerGroup,
                                            })
                                        }
                                    >
                                        <FaLongArrowAltLeft />
                                    ...
                                    <button
                                        ...
                                        onClick={() =>
                                            setFinalComponentPayload({
                                                ...finalComponentPayload,
                                                ownerGroup: targetComponent.ownerGroup,
                                            })
                                        }
                                    >
                                        <FaUndo />
                                ...
                                {sourceComponent.ownerCountry === targetComponent.ownerCountry ? (
                                    ...
                                    <button
                                        ...
                                        onClick={() =>
                                            setFinalComponentPayload({
                                                ...finalComponentPayload,
                                                ownerCountry: sourceComponent.ownerCountry,
                                            })
                                        }
                                    >
                                        <FaLongArrowAltLeft />
                                    ...
                                    <button
                                        ...
                                        onClick={() =>
                                            setFinalComponentPayload({
                                                ...finalComponentPayload,
                                                ownerCountry: targetComponent.ownerCountry,
                                            })
                                        }
                                    >
                                        <FaUndo />
                                        ...
                                        <div className='col-12 col-md-2 mx-5 text-center'>
                                            {!c.overWritten ? (
                                                <button
                                                    ...
                                                    onClick={() => {
                                                        const moderators = (
                                                            finalComponentPayload.moderators ?? []
                                                        ...
                                                        const updatedModeratorsMergeList = moderatorsMergeList.map(
                                                            (mod) => {
