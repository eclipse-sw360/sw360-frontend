                    ...
                    <div className="mb-3">
                        <div className="border-bottom fw-bold text-uppercase text-blue border-blue mb-2">{t('Releases')}</div>
                        {
                            (sourceComponent.releaseIds ?? []).map(rel => {
                                    const release = sourceComponent._embedded?.["sw360:releases"]?.filter(r => r.id === rel)[0]
                                    return (
                                        <div className="d-flex row mb-1" key={rel}>
                    ...
                    <div className="mb-3">
                        <div className="border-bottom fw-bold text-uppercase text-blue border-blue mb-2">{t('Attachments')}</div>
                        {
                            (sourceComponent.attachments ?? []).map(att => {
                                    return (
                                        <div className="d-flex row mb-1" key={att.attachmentContentId}>
