...
export default function CreatePackage() {
    ...
    const [ packagePayload, setPackagePayload ] = useState<Package>({
        createdOn: `${d.getDate()}/${d.getMonth()}/${d.getFullYear()}`
    })
                    ...
                    <div className="col ms-2 me-4 mt-2">
                        <Tab.Content>
                            <Tab.Pane eventKey='summary'>
                                <CreateOrEditPackage packagePayload={packagePayload} setPackagePayload={setPackagePayload} handleSubmit={handleCreatePackage} creatingPackage={creatingPackage} />
                            </Tab.Pane>
                        </Tab.Content>
                    </div>
                </div>
