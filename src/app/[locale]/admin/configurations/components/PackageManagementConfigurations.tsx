            ...
            <tbody>
                <tr id='is-package-management-enabled'>
                    <td className='align-middle fw-bold'>
                        {t('Enable Package Management Feature')}
                    </td>
                    <td>
                        <OnOffSwitch size={25}
                    ...
                    <td>
                        {t('is-package-management-enabled_description')}
                    </td>
                </tr>
                <tr id='package-management-write-access-usergroup'>
                    <td className='align-middle fw-bold'>
                        {t('Package Management Write Access User Group')}
                    </td>
                    <td>
                        <SelectUserGroup
                    ...
                    <td className='align-middle'>
                        {t('package_management_write_access_usergroup_description')}
                    </td>
                </tr>
                <tr id='sbom-tool-name'>
                    ...
                    <td className='align-middle'>
                        {t('sbom_tool_name_description')}
                    </td>
                </tr>
                <tr id='sbom-vendor-name'>
                    <td className='align-middle fw-bold'>
                        {t('SBOM Tool Vendor Name')}
                    </td>
                    <td>
                        <input
                            className='form-control form-control-sm'
                    ...
                    <td className='align-middle'>
                        {t('sbom_vendor_name_description')}
                    </td>
                </tr>
            </tbody>
        </table>
