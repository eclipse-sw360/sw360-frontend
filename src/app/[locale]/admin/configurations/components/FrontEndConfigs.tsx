...
import { ArrayTypeUIConfigKeys, UIConfigKeys, UiConfiguration } from '@/object-types'
import { useTranslations } from 'next-intl'
import { Dispatch, type JSX, SetStateAction, useState } from 'react'

interface Props {
    currentUiConfig: UiConfiguration
    setCurrentUiConfig: Dispatch<SetStateAction<UiConfiguration | undefined>>
}

const FrontEndConfigs = ({ currentUiConfig, setCurrentUiConfig }: Props): JSX.Element => {
    ...
    const [arrayKeyStates, setArrayKeyStates] = useState(
        () =>
            Object.fromEntries(
    ...
    const onArrayStateChangeHandler = (key: UIConfigKeys) => (newValues: Set<string>) => {
        setArrayKeyStates((prev) => ({ ...prev, [key]: new Set(newValues) }))
        setCurrentUiConfig(
            (prev) =>
                ({
                    ...prev,
            ...
            <table className='table label-value-table'>
                ...
                <tbody>
                    ...
                    <tr id='ui-project-externalurls'>
                        ...
                        <td>
                            <PillsInput
                                ...
                                onTagsChange={onArrayStateChangeHandler(UIConfigKeys.UI_PROJECT_EXTERNALURLS)}
                            />
                        </td>
                    ...
                    <tr id='ui-project-externalkeys'>
                        ...
                        <td>
                            <PillsInput
                                ...
                                onTagsChange={onArrayStateChangeHandler(UIConfigKeys.UI_PROJECT_EXTERNALKEYS)}
                            />
                        </td>
                    ...
                    <tr id='ui-custommap-project-roles'>
                        ...
                        <td>
                            <PillsInput
                                ...
                                onTagsChange={onArrayStateChangeHandler(UIConfigKeys.UI_CUSTOMMAP_RELEASE_ROLES)}
                            />
                        </td>
                    ...
                    <tr id='ui-clearing-team-unknown-enabled'>
                        ...
                        <td>
                            <OnOffSwitch
                                ...
                                checked={currentUiConfig[UIConfigKeys.UI_CLEARING_TEAM_UNKNOWN_ENABLED] === 'true'}
                    ...
                    <tr id='ui-org-eclipse-sw360-disable-clearing-request-for-project-group'>
                        <td className='align-middle fw-bold'>{t('Disable Clearing Request for Project Groups')}</td>
                        <td>
                            <PillsInput
                                tags={
                                    arrayKeyStates[
                    ...
                    <tr id='ui-component-categories'>
                        ...
                        <td>
                            <PillsInput
                                ...
                                onTagsChange={onArrayStateChangeHandler(UIConfigKeys.UI_COMPONENT_CATEGORIES)}
                            />
                        </td>
                    ...
                    <tr id='ui-custommap-component-roles'>
                        ...
                        <td>
                            <PillsInput
                                ...
                                onTagsChange={onArrayStateChangeHandler(UIConfigKeys.UI_CUSTOMMAP_COMPONENT_ROLES)}
                            />
                        </td>
                    ...
                    <tr id='ui-component-externalkeys'>
                        ...
                        <td>
                            <PillsInput
                                ...
                                onTagsChange={onArrayStateChangeHandler(UIConfigKeys.UI_COMPONENT_EXTERNALKEYS)}
                            />
                        </td>
                    ...
                    <tr id='ui-release-externalkeys'>
                        ...
                        <td>
                            <PillsInput
                                ...
                                onTagsChange={onArrayStateChangeHandler(UIConfigKeys.UI_RELEASE_EXTERNALKEYS)}
                            />
                        </td>
                    ...
                    <tr id='ui-programming-languages'>
                        ...
                        <td>
                            <PillsInput
                                ...
                                onTagsChange={onArrayStateChangeHandler(UIConfigKeys.UI_PROGRAMMING_LANGUAGES)}
                            />
                        </td>
                    ...
                    <tr id='ui-enable-add-license-info-to-release-button'>
                        ...
                        <td>
                            <OnOffSwitch
                                ...
                                setCurrentUiConfig={setCurrentUiConfig}
                                checked={
                                    currentUiConfig[UIConfigKeys.UI_ENABLE_ADD_LICENSE_INFO_TO_RELEASE_BUTTON] ===
                                    'true'
                                }
                    ...
                    <tr id='ui-custom-welcome-page-guideline'>
                        ...
                        <td>
                            <OnOffSwitch
                                size={25}
                                setCurrentUiConfig={setCurrentUiConfig}
                                checked={currentUiConfig[UIConfigKeys.UI_CUSTOM_WELCOME_PAGE_GUIDELINE] === 'true'}
                    ...
                    <tr id='ui-enable-security-vulnerability-monitoring'>
                        <td className='align-middle fw-bold'>{t('Enable Security Vulnerability Monitoring')}</td>
                        <td>
                            <OnOffSwitch
                                size={25}
                                setCurrentUiConfig={setCurrentUiConfig}
                                checked={
                                    currentUiConfig[UIConfigKeys.UI_ENABLE_SECURITY_VULNERABILITY_MONITORING] === 'true'
                                }
                    ...
                    <tr id='ui-rest-apitoken-generator-enable'>
                        ...
                        <td>
                            <OnOffSwitch
                                size={25}
                                setCurrentUiConfig={setCurrentUiConfig}
                                checked={currentUiConfig[UIConfigKeys.UI_REST_APITOKEN_GENERATOR_ENABLE] === 'true'}
