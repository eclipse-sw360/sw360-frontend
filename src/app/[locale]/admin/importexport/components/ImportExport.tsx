            ...
            <div className='row'>
                <div className='col'>
                    ...
                    <div className='mb-2'>
                        <button
                            ...
                            onClick={() => handleDownload('importExport/downloadComponent', 'components.csv', { 'Accept': 'text/plain' })}
                        >
                    ...
                    <div className='mb-2'>
                        <button
                            className='btn btn-secondary w-50 text-start'
                            onClick={() => handleDownload('importExport/downloadComponentTemplate', 'component_template.csv', { 'Accept': 'text/plain' })}
                        >
                    ...
                    <div className='mb-2'>
                        <button
                            className='btn btn-secondary w-50 text-start'
                            onClick={() => handleDownload('importExport/downloadAttachmentSample', 'attachment_sample_info.csv', { 'Accept': 'text/plain' })}
                        >
                    ...
                    <div className='mb-2'>
                        <button
                            className='btn btn-secondary w-50 text-start'
                            onClick={() => handleDownload('importExport/downloadAttachmentInfo', 'attachment_info.csv', { 'Accept': 'text/plain' })}
                        >
                    ...
                    <div className='mb-2'>
                        <button
                            className='btn btn-secondary w-50 text-start'
                            onClick={() => handleDownload('importExport/downloadReleaseSample', 'release_link_sample_info.csv', { 'Accept': 'text/plain' })}
                        >
                    ...
                    <div className='mb-2'>
                        <button
                            className='btn btn-secondary w-50 text-start'
                            onClick={() => handleDownload('importExport/downloadReleaseLink', 'release_link_info.csv', { 'Accept': 'text/plain' })}
                        >
                    ...
                    <div className='mb-2'>
                        <button
                            className='btn btn-secondary w-50 text-start'
                            onClick={() => handleDownload('licenses/downloadLicenses', 'LicensesBackup.lics', { 'Accept': 'application/zip' })}
                        >
                ...
                <div className='col'>
                    ...
                    <div className='mb-2 d-flex justify-content-between'>
                        <input type='file' onChange={(e) => handleFileChange(e, componentCsvFile)}/>
                        <button 
                            className='btn btn-secondary w-50 text-start'
                            onClick={() => handleUpload('importExport/uploadComponent', 'componentFile', componentCsvFile)}
                        >
                            <MdOutlineFileUpload size={25} /> {t('Upload Component CSV')}
                        </button>
                    </div>
                    <div className='mb-2 d-flex justify-content-between'>
                        <input type='file' onChange={(e) => handleFileChange(e, componentsAttachmentFile)}/>
                        <button 
                            className='btn btn-secondary w-50 text-start'
                            onClick={() => handleUpload('importExport/componentAttachment', 'attachmentFile', componentsAttachmentFile)}
                        >
                            <MdOutlineFileUpload size={25} /> {t('Upload Component Attachments')}
                        </button>
                    </div>
                    <div className='mb-2 d-flex justify-content-between'>
                        <input type='file' onChange={(e) => handleFileChange(e, releaseLinksFile)}/>
                        <button 
                            className='btn btn-secondary w-50 text-start'
                    ...
                    <div className='mb-2 d-flex justify-content-between'>
                        <input type='file' onChange={(e) => handleFileChange(e, licenseArchiveFile)}/>
                        <button 
                            className='btn btn-secondary w-50 text-start'
