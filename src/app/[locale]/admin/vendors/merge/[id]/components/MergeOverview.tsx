                        ...
                        >
                            ...
                            {mergeState === MergeOrSplitActionType.CONFIRM ? (
                                ...
                                <button
                                    type='button'
                                    className='btn btn-primary'
                                    disabled={GetNextState(mergeState) === null || sourceVendor === null}
                                    onClick={() => {
                                        if (GetNextState(mergeState) !== null) {
                                            if (
                                                sourceVendor !== null &&
                                                sourceVendor._links?.self.href.split('/').at(-1) === id
                                            ) {
                                                setErr(
                                                    'Please choose exactly one vendor, which is not the vendor itself!',
                                                )
