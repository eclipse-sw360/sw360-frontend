...
import { ClientSidePageSizeSelector, ClientSideTableFooter, EccPrintButton, SW360Table, TableSearch } from 'next-sw360'
...
function EccDetails({ projectId, projectName, projectVersion }: Props): JSX.Element {
    ...
    const searchFunction = (valueOrEvent: string | KeyboardEvent<HTMLInputElement>) => {
        table.setPageIndex(0)
        setGlobalFilter(typeof valueOrEvent === 'string' ? valueOrEvent : valueOrEvent.currentTarget.value)
    }
