        ...
        toggle ? (
          <>
            <div style={{ marginRight: '0.25rem' }}>
              <BsCaretDownFill className='cursor' size='13' onClick={() => setToggle(!toggle)} />
            </div>
            <div>
              {Object.values(sortIgnoreCase(licenses))
                .map((license): React.ReactNode => (
                  <span key={license}>
          ...
          <>
            <div style={{ marginRight: '0.25rem' }}>
              <BsCaretRightFill className='cursor' size='13' onClick={() => setToggle(!toggle)} />
            </div>
            <div>
              <div>
