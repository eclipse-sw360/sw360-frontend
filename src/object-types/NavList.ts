    ...
    return [
        ...
        },
        {
            ...
            childs: [
                ...
                {
                    href: '/admin/fossology',
                    name: t('Fossology'),
                    id: 'admin_fossology',
                },
                {
                    href: '/admin/importexport',
                ...
                {
                    href: '#',
                    name: t('Attachment Cleanup'),
                    id: 'admin_attachment_cleanup',
                },
                {
                    href: '/admin/oauthclient',
                    name: t('OAuth Client'),
                    id: 'admin_oauth_client',
                },
                {
                    href: '/admin/licenseTypes',
                    name: t('License Types'),
                    id: 'admin_license_types',
                },
                {
