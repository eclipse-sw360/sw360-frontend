    ...
    return (
        <div className='card-deck'>
            <div id='component-quickfilter' className='card'>
                <div className='card-header'>{t('Advanced Search')}</div>
                    ...
                    <Form>
                        ...
                        <Form.Group className='mb-3' controlId='softwarePlatform'>
                            ...
                            <Form.Control
                                ...
                                value={searchParams.softwarePlatform}
                                onChange={handleSearchParam}
                            />
                        </Form.Group>
                        ...
                        <Form.Group className='mb-3' controlId='operatingSystem'>
                            ...
                            <Form.Control
                                ...
                                value={searchParams.operatingSystem}
                                onChange={handleSearchParam}
                            />
                        </Form.Group>
                        <Form.Group className='mb-3' controlId='mainLicenses'>
                            ...
                            <Form.Control
                                ...
                                size='sm'
                                name='mainLicenses'
                                value={searchParams.mainLicenses}
                                onChange={handleSearchParam}
                            />
                        </Form.Group>
                        ...
                        <Form.Group className='mb-3' controlId='createdOn'>
                            ...
                            <Form.Select
                                size='sm'
                                style={{ display: 'inline-block', width: '40% !important' }}
                        ...
                        <Form.Group>
                            <Button
                                size='sm'
                                style={{ backgroundColor: '#F7941E', width: '100%' }}
