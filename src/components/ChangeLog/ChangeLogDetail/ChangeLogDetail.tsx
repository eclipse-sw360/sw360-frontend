...
const ChangeLogDetail = ({ changeLogData }: Props) => {
  ...
  const handleReferenceDoc: any = () => {
    if (CommonUtils.isNullOrUndefined(changeLogData.referenceDoc) && CommonUtils.isNullOrUndefined(changeLogData.info)) {
      return (
        <>
      ...
      return (
        <>
          ...
          <td className='text-justify col-4 p-3'><PrettyFormatData data={changeLogData.referenceDoc} /></td>
        </>
      )
      ...
      return (
        <>
          ...
          <td className='text-justify col-4 p-3'><PrettyFormatData data={changeLogData.info} /></td>
        </>
      )
    } else {
      return (
          ...
          <table className='table label-value-table' style={{ marginBottom: '2rem' }}>
            ...
            <tbody hidden={toggle} className='border'>
              <tr className='row' style={{ margin: '0px' }}>
                ...
                <td className='text-justify col-4 p-3' style={{ borderRight: '1px solid lightgrey' }}>{changeLogData.userEdited}</td>
              ...
              <tr className='row' style={{ margin: '0px' }}>
                ...
                <td className='text-justify col-4 p-3' style={{ borderRight: '1px solid lightgrey' }}>{changeLogData.changeTimestamp}</td>
              ...
              <tr className='row' style={{ margin: '0px' }}>
                ...
                <td className='text-justify col-4 p-3' style={{ borderRight: '1px solid lightgrey' }}>{changeLogData.operation}</td>
                {handleReferenceDoc()}
              </tr>
            </tbody>
