...
export default function LinkedProjects() {
    ...
    return (
        <>
            ...
            <Container>
                <Row className="mb-4">
                    <Row className={`${styles["header-1"]} mb-2 border-bottom`}>
                        <h6 className="fw-bold mt-3">LINKED PROJECTS</h6>
                    </Row>
                    <Row>
                        <Col lg={4} >
                            <Button variant="light" className={`${styles["button-plain"]}`} onClick={() => setShowLinkProjectsModal(true)} >Link Projects</Button>
                        </Col>
                    </Row>
                </Row>
                <Row className="mb-4">
                    ...
                    <Row>
                        <Col lg={4} >
                                <Button variant="light" className={`${styles["button-plain"]}`} onClick={() => setShowLinkReleasesModal(true)} >Link Releases</Button>
                        </Col>
                    </Row>
                </Row>
            </Container>
