...
import { ECCInterface, InputKeyValue, User } from '@/object-types'
...
const printEccTable = ({ title, rows, headers, noRowsMessage }: EccPrintOptions): void => {
